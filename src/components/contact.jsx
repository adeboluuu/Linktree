  ...
  return (
    <div className='my-20 mx-auto text-center sm:w-6/12 w-10/12'>
      ...
      <div className='sm:grid grid-cols-2 gap-8 block text-left my-3'>
        <div className="my-3">
          <label className="block text-sm font-medium mb-2" for="username"> First name</label>
          <input className="shadow appearance-none h-11 border font-normal rounded-lg w-full py-2 px-3 text-[#667085] leading-tight focus:outline-none focus:shadow " id="first_name" placeholder="Enter your first name" />
        </div>
        
        <div className="my-3 ">
          <label class="block  text-sm font-medium  mb-2" for="Lastname">Last name</label>
          <input className="shadow appearance-none border h-11 font-normal rounded-lg w-full py-2 px-3 text-[#667085] leading-tight focus:outline-none focus:shadow-outline"type="text" id="last_name" placeholder="Enter your last name" />
        </div>
        ...
        <button type='submit 'className='bg-[#1570EF] text-white w-full rounded-lg h-12 mt-2'>Send Message</button>
      </form>
      <footer/>
    </div>
  )
